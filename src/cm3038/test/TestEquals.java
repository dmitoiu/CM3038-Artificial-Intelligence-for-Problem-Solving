// ---------------------------------------------------------------------------
// Darie-Dragos Mitoiu
// The Bridge and Torch Problem (TestEquals.java) v1.0.0 30/01/2020
...
public class TestEquals {
    ...
    public static void main(String[] args){
        ...
        // Add person objects to the east ArrayList of person objects
        ...
        BtState someState = new BtState(westPersonList, eastPersonList, TorchLocation.EAST, bridge);
        // Create goal state object
        BtState goalState = new BtState(eastPersonList, westPersonList, TorchLocation.EAST, bridge);
        System.out.println("Initial state equals some state -> " + initialState.equals(someState));
        System.out.println("Initial state hashcode          -> " + initialState.hashCode());
        System.out.println("Goal state hashcode             -> " + goalState.hashCode());
    }
}
